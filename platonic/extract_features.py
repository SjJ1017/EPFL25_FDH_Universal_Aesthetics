...
def extract_llm_features(filenames, dataset, args):
    ...
    texts = [str(x['content']) for x in dataset]

    for llm_model_name in filenames[::-1]:
        print(f"Processing LLM model: {llm_model_name}")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--modelset",       type=str, default="val", choices=["val", "test", "local_test", "custom"])
